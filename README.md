...
# Justificación
Las empresas día a día reciben grandes volúmenes de facturas provenientes de diversos proveedorres, esto limita la toma de decisione oportunas basadas en la información de este volumen masivo de datos. En consecuencia, estos datos se tornan subutilizados y olvidados en el tiempo.
...
![Diagrama MER](Data\Diagrama MER.jpg)